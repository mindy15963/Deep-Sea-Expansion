...
public class ItemDinghy extends ItemBase
{
	public ItemDinghy(String name)
	{
		super(name);
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
	{
		...
		else
		{
			...
			else
			{
				...
				EntityDinghy entityboat = new EntityDinghy(worldIn, raytraceresult.hitVec.x, flag1 ? raytraceresult.hitVec.y - 0.12D : raytraceresult.hitVec.y, raytraceresult.hitVec.z);
