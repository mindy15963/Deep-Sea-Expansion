...
public class ModelDinghy extends ModelBase implements IMultipassModel
{
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        EntityDinghy entityboat = (EntityDinghy)entityIn;
    ...
    protected void renderPaddle(EntityDinghy boat, int paddle, float scale, float limbSwing)
    {
